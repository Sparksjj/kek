...
@Component({
  selector: 'ms-create-partners',
  templateUrl: './create-partners.component.html',
  styleUrls: ['./create-partners.component.scss'],
  host: {
    '[@routeAnimation]': 'true'
  },
  animations: [routeAnimation]
})
export class CreatePartnersComponent implements OnInit {
